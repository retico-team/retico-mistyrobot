...
class MistyReferModule(retico_core.AbstractModule):
    ...
    def process_update(self, update_message):
        for iu, ut in update_message:
            ...
            if isinstance(iu, DetectedObjectsIU):
                self.current_objects = iu.payload
                return None

            if isinstance(iu, RobotStateIU):
                state_update = iu.payload
        ...
        print('DECISION:', iu.payload['decision'])
